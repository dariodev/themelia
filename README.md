...
-	[Description](#description)
	-	[Features](#features)
-	[Theme Options - Customizer](#theme-options---customizer)
	-	[Site Identity](#site-identity)
	-	[Site Title and Header](#site-title-and-header)
	-	[Main navigation](#main-navigation)
	-	[Body Text and Links](#body-text-and-links)
	-	[Text Size - Modular Scale](#text-size---modular-scale)
	-	[Headings & Entry Titles](#headings--entry-titles)
	-	[Breadcrumbs & Secondary Text](#breadcrumbs--secondary-text)
	-	[Layout](#layout)

...
add_action( 'after_setup_theme', 'themelia_custom_background_setup', 15 );
 ...
 * @return void
 */
function themelia_custom_background_setup() {
	...
	add_theme_support(
		...
		array(
			...
			'default-image'    => '',
			'wp-head-callback' => 'themelia_custom_background_callback',
		)
	);
}
 ...
 * @return void
 */
function themelia_custom_background_callback() {

...
$author_weblink     = get_the_author_link();
...
if ( $author_description ) : ?>
	...
	<aside id="author-box" class="author-info clr">
		<?php if( themelia_has_gravatar( $author_email )) { ?>
			<a href="<?php echo $author_url; ?>" class="author-avatar clr" rel="author">
		...
		<div class="author-bio clr">
			<div class="author-description">
				...
				<p><a href="<?php echo $author_posts_link; ?>" title="<?php esc_html_e( 'View all author posts', 'themelia' ); ?>"><?php esc_html_e( 'View all author posts', 'themelia' ); ?></a></p>
